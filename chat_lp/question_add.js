function next_chat_go() {
    ...
    console.log(c, document.getElementById("list9").children[0].textContent, 'CTEST')
    ...
    for (var c = next_chat_num; c < count; c++) {
        ...
        console.log(document.getElementById("list9"))
        console.log(c, document.getElementById("list9").children[c].textContent)
